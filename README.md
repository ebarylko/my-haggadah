...
* [`src/haggadah/styles.cljs`](src/haggadah/styles.cljs): CSS compilation source file (ClojureScript,
[Garden](https://github.com/noprompt/garden))
* [`src/haggadah/`](src/haggadah/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/haggadah/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `haggadah` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/haggadah/config.cljs) defaults to `true` in
...
```clj
(ns haggadah.example
  (:require [haggadah.config :as config])
